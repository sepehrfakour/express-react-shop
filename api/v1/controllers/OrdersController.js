  ...
  addOrder(req,res) {
    if (req.body) {
      let data = {
        ...
        subtotal_price_amount: req.body.subtotal_price_amount,
        total_price_amount: req.body.total_price_amount,
        tax_price_amount: req.body.tax_price_amount,
        shipping_method: req.body.shipping_method,
        shipping_price_amount: req.body.shipping_price_amount,
